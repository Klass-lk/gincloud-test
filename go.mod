module github.com/klass-lk/test

go 1.25.0

require (
	github.com/klass-lk/ginboot v1.22.4
	github.com/klass-lk/ginboot/db/inmemory v1.22.4
	github.com/klass-lk/ginboot/runtime/lambda v1.22.4
	github.com/klass-lk/ginboot/telemetry v1.22.4
)
