...
require (
	github.com/klass-lk/ginboot v1.23.0
	github.com/klass-lk/ginboot/db/inmemory v1.23.0
	github.com/klass-lk/ginboot/runtime/lambda v1.23.0
	github.com/klass-lk/ginboot/telemetry v1.23.0
)
